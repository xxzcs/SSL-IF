...
NUM_LABELS=${NUM_LABELS:-4390}
LABEL_RATIO=${LABEL_RATIO:-1.0}
NUM_TRAIN_ITER=${NUM_TRAIN_ITER:-13750}
NUM_EVAL_ITER=${NUM_EVAL_ITER:-275}
NUM_LOG_ITER=${NUM_LOG_ITER:-275}
NUM_WARMUP_ITER=${NUM_WARMUP_ITER:-550}
LR_DROP_ITER=${LR_DROP_ITER:-"4125 8250 12375"}
LPATH=${LPATH:-../data_split/19/labeled_images_all.pth}
ULPATH=${ULPATH:-../data_split/19/labeled_images_all.pth}
NAME_PREFIX=${NAME_PREFIX:-supervised_bus_ld05_all}
METHOD_SUFFIX=${METHOD_SUFFIX:-supervised_bus_ld05_all}
SUMMARY=${SUMMARY:-results/supervised_bus_ld05_all_latest.csv}
...
LOG=${LOG:-logs/supervised_bus_ld05_all_${STAMP}.log}
...
echo "[$(date)] ===== Supervised BUS ld=0.5 all-labeled start ====="
...
touch "results/ALL_DONE_SUPERVISED_BUS_LD05_ALL"
echo "[$(date)] ===== Supervised BUS ld=0.5 all-labeled done ====="
