...
LOG=logs/bus_ifcf_residual_tuning_ld05_${STAMP}.log
exec > >(tee -a "$LOG") 2>&1

FIX=config/usb_cv/fixmatch/fixmatch_bus_878_0.yaml
SUMMARY=${SUMMARY:-results/fixmatch_ifcf_bus_ld05_residual_tuning_latest.csv}
SEEDS=${SEEDS:-"1 2 3"}
VARIANTS=${VARIANTS:-"lambda05 lambda075 ramp"}
...
touch results/ALL_DONE_BUS_FIXMATCH_IFCF_RESIDUAL_TUNING_LD05
echo "[$(date)] ===== BUS ld0.5 residual tuning sweep done ====="
