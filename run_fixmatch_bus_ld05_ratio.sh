...
case "$RATIO" in
  5)
    ...
    NAME_PREFIX="fixmatch_bus_ld05_ratio5"
    METHOD_SUFFIX="fixmatch_bus_ld05_ratio5"
    SUMMARY="results/fixmatch_bus_ld05_ratio5_latest.csv"
    ;;
  10)
    NUM_LABELS=439
    NUM_TRAIN_ITER=5500
    ...
    NAME_PREFIX="fixmatch_bus_ld05_ratio10"
    METHOD_SUFFIX="fixmatch_bus_ld05_ratio10"
    SUMMARY="results/fixmatch_bus_ld05_ratio10_latest.csv"
    ;;
  15)
    NUM_LABELS=659
    NUM_TRAIN_ITER=4150
    ...
    NAME_PREFIX="fixmatch_bus_ld05_ratio15"
    METHOD_SUFFIX="fixmatch_bus_ld05_ratio15"
    SUMMARY="results/fixmatch_bus_ld05_ratio15_latest.csv"
    ;;
  30)
    NUM_LABELS=1317
    NUM_TRAIN_ITER=8250
    ...
    NAME_PREFIX="fixmatch_bus_ld05_ratio30"
    METHOD_SUFFIX="fixmatch_bus_ld05_ratio30"
    SUMMARY="results/fixmatch_bus_ld05_ratio30_latest.csv"
    ;;
  *)
...
LOG=${LOG:-logs/fixmatch_bus_ld05_ratio${RATIO}_${STAMP}.log}
...
echo "[$(date)] ===== FixMatch BUS ld=0.5 ratio=${RATIO}% start ====="
echo "base=${BASE}"
...
touch "results/ALL_DONE_FIXMATCH_BUS_LD05_RATIO${RATIO}"
echo "[$(date)] ===== FixMatch BUS ld=0.5 ratio=${RATIO}% done ====="
