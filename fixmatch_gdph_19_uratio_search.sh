...
BASE_CONFIG="config/usb_cv/fixmatch/fixmatch_gdph_0.yaml"
URATIOS=${URATIOS:-"5 7 10 15 30"}

for uratio in ${URATIOS};
do
    ...
    do
        ...
        do
            seed=${run}
            save_name="fixmatch_gdph_u${uratio}_fold${fold}_${run}"
            ...
            sed "s/^uratio:.*/uratio: ${uratio}/" > "${temp_config}"
