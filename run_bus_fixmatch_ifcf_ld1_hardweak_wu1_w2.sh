...
LOG=${LOG:-logs/bus_fixmatch_ifcf_ld1_hardweak_wu1_w2_${STAMP}.log}
BASE=${BASE:-config/usb_cv/fixmatch/fixmatch_bus_878_0.yaml}
SUMMARY=${SUMMARY:-results/fixmatch_ifcf_bus_ld1_hardweak_wu1_w2_latest.csv}
TAG=${TAG:-fixmatch_ifcf_bus_ld1_hard_False_wu1_w2}
...
echo "[$(date)] ===== BUS FixMatch+IFCF ld=1.0 hard-weak warmup1 weight2 start ====="
echo "base=${BASE}"
...
touch results/ALL_DONE_BUS_FIXMATCH_IFCF_LD1_HARDWEAK_WU1_W2
echo "[$(date)] ===== BUS FixMatch+IFCF ld=1.0 hard-weak warmup1 weight2 done ====="
