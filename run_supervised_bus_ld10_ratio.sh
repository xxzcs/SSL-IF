...
case "$RATIO" in
  5)
    ...
    NAME_PREFIX="supervised_bus_ld10_ratio5"
    METHOD_SUFFIX="supervised_bus_ld10_ratio5"
    SUMMARY="results/supervised_bus_ld10_ratio5_latest.csv"
    ;;
  *)
...
LOG=${LOG:-logs/supervised_bus_ld10_ratio${RATIO}_${STAMP}.log}
...
echo "[$(date)] ===== Supervised BUS ld=1.0 ratio=${RATIO}% start ====="
...
touch "results/ALL_DONE_SUPERVISED_BUS_LD10_RATIO${RATIO}"
echo "[$(date)] ===== Supervised BUS ld=1.0 ratio=${RATIO}% done ====="
