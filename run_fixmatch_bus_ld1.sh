...
SUMMARY=${SUMMARY:-results/fixmatch_bus_ld1_pcut09_latest.csv}
NAME_PREFIX=${NAME_PREFIX:-fixmatch_bus_ld1}
METHOD_SUFFIX=${METHOD_SUFFIX:-fixmatch_bus_ld1}
SEEDS=${SEEDS:-"1 2 3 4 5"}
FORCE_RERUN=${FORCE_RERUN:-0}
STAMP=$(date +%Y%m%d_%H%M%S)
LOG=${LOG:-logs/fixmatch_bus_ld1_${STAMP}.log}
...
echo "[$(date)] ===== FixMatch BUS ld=1.0 start ====="
echo "base=${BASE}"
...
touch results/ALL_DONE_FIXMATCH_BUS_LD1
echo "[$(date)] ===== FixMatch BUS ld=1.0 done ====="
